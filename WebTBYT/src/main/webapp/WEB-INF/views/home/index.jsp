...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/static/images/slideshow/slide5.png" alt="Los Angeles" width="100%" height="342px">
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/slide6.png" alt="Los Angeles" width="100%" height="342px">
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/slide7.png" alt="Los Angeles" width="100%" height="342px">
					</div>
				</div>
              </div>
		</div>
	...
	<br> <img src="/static/images/banner5.png" width="100%" />
